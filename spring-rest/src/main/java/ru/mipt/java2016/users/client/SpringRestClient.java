package ru.mipt.java2016.users.client;
...
public class SpringRestClient {
    ...
    private static void listAllUsers() {
        ...
        ResponseEntity<List> response = restTemplate
                .exchange(REST_SERVICE_URI + "/user/", HttpMethod.GET, request, List.class);
    ...
    private static void getUser() {
        ...
        ResponseEntity<User> response = restTemplate
                .exchange(REST_SERVICE_URI + "/user/1", HttpMethod.GET, request, User.class);
    ...
    private static void updateUser() {
        ...
        HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
        ResponseEntity<User> response = restTemplate
                .exchange(REST_SERVICE_URI + "/user/1", HttpMethod.PUT, request, User.class);
